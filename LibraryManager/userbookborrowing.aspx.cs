...
{
    public partial class userbookborrowing : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                TextBox5.Text = startDate.ToString("yyyy-MM-dd");
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            if (checkIfBookExist() && checkIfMemberExist())
            {
                ...
                {
                    this.Page.ClientScript.RegisterStartupScript(this.GetType(),"toastr_message", "toastr.warning('You already have this book')", true);
                }
                else
                {
                    issueBook();
        ...
        void returnBook()
        {
            ...
            {
                this.Page.ClientScript.RegisterStartupScript(this.GetType(), "toastr_message", "toastr.error(ex.Message)", true);
            }
        }
